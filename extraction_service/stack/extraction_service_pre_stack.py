...
class ExtractionServicePreStack(NestedStack):
    ...
    def deploy_provision(self):
        ...
        lambda_provision = _lambda.Function(self, 
            id='provision_opensearch_function', 
            function_name=f"extr-srv-extr-provision{self.instance_hash}", 
            runtime=_lambda.Runtime.PYTHON_3_12,
            handler='extr-srv-extr-provision.on_event',
            code=_lambda.Code.from_asset(os.path.join("./", "extraction_service/lambda/extr-srv-extr-provision")),
        ...
        lambda_provision_opensearch_invoke_role = _iam.Role(
        ...
        # Create ServiceLined role, lambda layers
        c_resource = custom_resources.AwsCustomResource(self,
            id=f"provision-opensearchpy-invoke",
            ...
            role=lambda_provision_opensearch_invoke_role
        )    
