...
class VideoMain extends React.Component {
    ...
    handleThumbnailClick = taskId => {
        this.setState({selectedItemId: taskId});
    }
    ...
    render() {
        return (
            <div className="videomain">
                ...
                :<VideoDetail taskId={this.state.selectedItemId} onClose={(detail)=> this.setState({selectedItemId: null})}></VideoDetail>
                }
                <Modal
                    onDismiss={() => this.setState({showUploadModal: false})}
                    visible={this.state.showUploadModal}
                    header="Upload and analysis"
                    size='max'
                >
