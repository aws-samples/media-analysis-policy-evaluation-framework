S3_BUCKET_NAME_PREFIX = 'content-analysis'
COGNITO_INVITATION_EMAIL_TITLE = 'Your temporary password for the ##APP_NAME##'
APP_NAME = 'Media Analysis & Policy Assessment'
SSM_INSTRUCTION_URL = 'https://gitlab.aws.dev/lanaz/aws-genai-policy-evaluation#access-opensearch-dashboard'
