...
from policy_eval_frontend.stack.constant import *
...
class FrontendStack(NestedStack):
    ...
    def __init__(self, scope: Construct, construct_id: str, 
        ...
        _s3_deployment.BucketDeployment(
            ...
            sources=[_s3_deployment.Source.asset("./policy_eval_frontend/web/build")],
        ...
        # web_log_bucket_name = f'{S3_BUCKET_NAME_PREFIX}-log-{self.account_id}-{self.region}{self.instance_hash}'
        # web_log_bucket = _s3.Bucket.from_bucket_name(self, "WebLogBucket", web_log_bucket_name)
        # if not web_log_bucket:
        ...
        lambda_provision = _lambda.Function(self, 
            ...
            code=_lambda.Code.from_asset(os.path.join("./", "policy_eval_frontend/lambda/provision-web")),
