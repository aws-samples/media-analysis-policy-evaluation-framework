            ...
            <div className="videoframes">
                ...
                {this.state.items !== undefined && this.state.items !== null?this.state.items.map((l,i)=>{
                    return <div className='frame' onClick={()=>this.handleFrameClick(l.Timestamp)}>
                        ...
                        {l.Label && <div className='label'><b>Labels:</b> {l.Label}</div>}
                        {l.Moderation && <div className='label'><b>Moderation Labels:</b> {l.Moderation}</div>}
                        {l.Celebritie && <div className='label'><b>Celebrities:</b> {l.Celebritie}</div>}
                        {l.Text && <div className='label'><b>Text:</b> {l.Text}</div>}
                        {l.Subtitle && <div className='label'><b>Subtitle:</b> {l.Subtitle}</div>}
                    </div>
                }):<div/>}
                </div>
